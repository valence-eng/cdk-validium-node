...
func (_m *Etherman) GetLatestBlockHeader(ctx context.Context) (*etherman.HeaderWithHash, error) {
...
func (_m *Etherman) internalGetLatestBlockHeader(ctx context.Context) (*coretypes.Header, error) {
	ret := _m.Called(ctx)
